...
int main(int argc, char* argv[])
{
	...
	const struct argp argp = { options, parse_opt, "SCHEMA [TARGET...]", "C/C++ tool to verify a JSON file (or files) matches a given JSON Schema. Uses nlohmann/json-schema for validation." };
